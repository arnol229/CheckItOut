...
# setup(console=['gameexample.py'],
#     data_files = [os.path.join(pymunk_dir, 'chipmunk.dll'),
#     os.path.join(pygame_dir, 'pygame.dll')]
#     )
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "gameexample.py"
 
        #Name of program
        self.project_name = "Game Example"
    ...
    def run(self):
        ...
        pymunk_dir = os.path.dirname(pymunk.__file__)
        extra_datas.append(os.path.join(pymunk_dir, 'chipmunk.dll'))
